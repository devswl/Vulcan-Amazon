...
import co.vulcanlabs.library.objects.AmazonData
...
var amazonData: AmazonData? = null
...
fun initAdMobInterstitial(): Pair<Class<out MediationExtrasReceiver>, Bundle>? {
    val pair = amazonData?.interId?.let {
        ...
        Pair<Class<out MediationExtrasReceiver>, Bundle>(APSAdMobCustomEvent::class.java, bundle)
